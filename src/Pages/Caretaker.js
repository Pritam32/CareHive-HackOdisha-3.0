...
const Caretaker = () => {
  ...
  React.useEffect(() => {
    const q = query(collection(db, "Caretaker"));
    ...
    <img id="logo" class="navbar-brand" src="assets/carehive-removebg-preview.png" alt=""/>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/Babysitter">Babysitter</a>
          </li>
          <li class="nav-item">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style={{borderRadius: '6px'}}>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/caretaker2.jpg" class="d-block w-100" alt="..."/>
            </div>
            <div class="carousel-item">
              <img src="assets/caretaker1.jpg" width="10vh" class="d-block w-100" alt="..."/>
            </div>
...
<div className="mx-2">
    ...
    <div id="contact" class="newsletter py-5">
